#encoding: utf-8
import numpy as np
from test2.OptimizationAlgorithm.MOPSO.public import init,update,plot,P_objective

import time
from test2.OptimizationAlgorithm.MOPSO.public import ma_obj_test

class Mopso_res:
    def __init__(self,particals,max_,min_,thresh,cost_pv,cost_el,cost_fc,cost_ht,project_lifetime,life_time,mesh_div=10):
    ...
    def evaluation_fitness(self):
        ...
        print(self.in_,'in')
        self.fitness_ = ma_obj_test.fitness_ht(self.in_,cost_pv=self.cost_pv,cost_el=self.cost_el,cost_fc=self.cost_fc,
