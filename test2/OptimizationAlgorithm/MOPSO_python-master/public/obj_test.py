...
def energy_management(project_lifetime:int,life_time:int,bt,pv_output,pd_load):
...
if __name__ == '__main__':
    pv_cap = 1.446625188195396277e+03
    bt_cap = 2.581328095998840126e+03
    project_lifetime = 25
    life_time = 8760
    cost_pv = 5000
    cost_bt = 1900
